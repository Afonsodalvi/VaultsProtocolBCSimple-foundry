...
import "../contracts/examples/CharityVault.sol";
//import "../contracts/strategies/YearnStrategy.sol";
//https://coinmarketcap.com/pt-br/currencies/yearn-finance/
import "../contracts/strategies/AaveStrategy.sol";
//https://coinmarketcap.com/pt-br/currencies/aave/
...
contract ContractTest is DSTest {
	...
	//não usar o endereço é para fins de teste
	address pool = 0xAaa7cCF1627aFDeddcDc2093f078C3F173C46cA4; 
	function setUp() public {
		erc20 = new MockERC20("shit", "coin", 2**256 - 1);
		vault = new BaseVault();
		aave = new AaveStrategy(address(pool), //o pool está um endereço aleatório para fins de entendimento
		address(erc20),address(erc20),address(vault));
		//olhar na strategies AaveStrategy que teremos os parametros que inseri 
